...
def handle_commands(command, intents, random_responses):
    ...
    if "add note" in command:
        add_task(command.replace("add note", "").strip())
...
def main():
    ...
    while True:
        ...
        handle_commands(command, intents, random_responses)
...
def google_search(query):
    ...
    try:
        ...
        # Extract the first search result (you can customize this part based on your needs)
        ...
        speak("An error occurred while searching Google. Please try again later.")
