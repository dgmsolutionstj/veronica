...
__all__ = [
    ...
    'SDA_One_Trailing_Space', 'SpCompressedLexicon',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechMemoryStream',
    'STSF_CommonAppData', 'ISpeechPhraseElement', 'SpeechWordType',
    'DISPID_SWFEChannels', 'SPINTERFERENCE_TOOLOUD',
    'SpeechVisemeType', 'DISPID_SpeechCustomStream', 'SPBO_NONE',
    'DISPID_SPPConfidence', 'SRESoundEnd', 'DISPID_SVResume',
    'ISpDataKey', 'SPAUDIOBUFFERINFO', 'DISPID_SPELexicalForm',
    'DISPID_SPIProperties', 'DISPID_SLPsCount', 'SPBINARYGRAMMAR',
    'SPLO_DYNAMIC', 'SpeechMicTraining', 'DISPID_SVGetProfiles',
    'DISPID_SRRGetXMLErrorInfo', 'SREStateChange', 'SPSEMANTICFORMAT',
    'SPEI_ADAPTATION', 'SDTDisplayText', 'DISPID_SRGetPropertyNumber',
    'SAFT24kHz8BitMono', '_SPAUDIOSTATE', 'SPPS_Noncontent',
    'DISPID_SPPValue', 'SpStream', 'DISPID_SGRSTType',
    'DISPID_SPISaveToMemory', 'DISPID_SpeechVoiceEvent',
    'SAFTCCITT_ALaw_22kHzStereo', 'SASRun', 'DISPID_SRRecognizer',
    'DISPID_SRCEAdaptation', 'SRCS_Enabled',
    'SpTextSelectionInformation', 'SRAExport', 'SPPS_Function',
    'SPCS_DISABLED', 'SPWF_INPUT', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRSSupportedLanguages',
    'SpeechVoiceCategoryTTSRate', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SGRsCount', 'SpAudioFormat', 'SAFT16kHz16BitStereo',
    'ISpPhoneticAlphabetConverter', 'ISpeechObjectTokenCategory',
    'SPBO_TIME_UNITS', 'DISPID_SASState', 'SAFTNonStandardFormat',
    'SpSharedRecognizer', 'SPRECOSTATE', 'SpeechRuleAttributes',
    'SPFM_CREATE', 'SPAR_Medium', 'SVP_17', 'ISpRecoGrammar2',
    'SAFT32kHz8BitMono', 'eLEXTYPE_PRIVATE4',
    'SWPKnownWordPronounceable', 'SRTSMLTimeout',
    'SPEI_END_SR_STREAM', 'DISPID_SDKDeleteKey',
    'DISPID_SRCSetAdaptationData', 'SRADynamic',
    'DISPID_SpeechRecognizer', 'SpMMAudioIn', 'DISPID_SGRSTNextState',
    'SITooFast', 'DISPID_SRCEHypothesis',
    ...
    'SGPronounciation', 'DISPID_SPIGrammarId',
    'DISPID_SpeechObjectToken', 'ISpeechPhraseAlternate',
    'SpeechGrammarTagDictation', 'SPSLMA', 'SAFTNoAssignedFormat',
    'SECFNoSpecialChars', 'SWPUnknownWordUnpronounceable',
    'SpeechAudioFormatType', 'ISpPhoneConverter', 'SRATopLevel',
    'DISPID_SPPNumberOfElements', 'SAFTExtendedAudioFormat',
    'DISPID_SPEAudioSizeBytes', 'SINone', 'SPRST_ACTIVE_ALWAYS',
    'SpeechLexiconType', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SPPFirstElement', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SPWAVEFORMATTYPE', 'SGRSTTWord', 'SpeechAudioProperties',
    'ISpeechPhraseRule', 'ISpRecognizer2', 'eLEXTYPE_VENDORLEXICON',
    'SSTTTextBuffer', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVSpeak',
    ...
    'SpNullPhoneConverter', 'SPAUDIOSTATUS', 'tagSTATSTG',
    'SGLexical', 'SpeechRuleState', 'DISPID_SVDisplayUI',
    'DISPID_SPPParent', 'DISPID_SpeechGrammarRules',
    'DISPID_SGRSTPropertyValue', 'DISPID_SAFType',
    'ISpeechLexiconWord', 'eLEXTYPE_PRIVATE11', 'SITooQuiet',
    'DISPID_SpeechGrammarRule', 'DISPID_SVSLastBookmarkId',
    'DISPID_SVSPhonemeId', 'DISPID_SPEPronunciation',
    'ISpStreamFormatConverter', 'ISpPhoneticAlphabetSelection',
    'SpeechPropertyResourceUsage', 'LONG_PTR', 'SRTStandard',
    'DISPID_SGRSAddSpecialTransition', 'SDTPronunciation',
    'DISPID_SVPause', 'DISPID_SVEventInterests', 'SDTAlternates',
    'SPAUDIOSTATE', 'DISPID_SGRSAddWordTransition',
    'SPWORDPRONUNCIATION', 'SPTEXTSELECTIONINFO', 'SPVOICESTATUS',
    'SAFTDefault', 'SVP_7', 'DISPID_SPPName',
    'DISPID_SPRuleFirstElement', 'DISPID_SOTCId',
    'SpeechVisemeFeature', 'SPSNotOverriden', 'ISpeechRecoGrammar',
    'SLTApp', 'SPSHT_EMAIL', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRGetPropertyString', 'SVP_6', 'SPWT_LEXICAL',
    'SPEI_RESERVED5', 'ISpeechPhraseReplacements',
    'DISPID_SWFEFormatTag', 'DISPID_SRCERecognitionForOtherContext',
    'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPPS_Unknown',
    'DISPID_SpeechVoice', 'DISPID_SpeechPhraseElements',
    'ISpRecognizer3', 'SpeechDictationTopicSpelling', 'DISPID_SRGId',
    'SITooLoud', 'DISPID_SLPLangId', 'DISPID_SRRGetXMLResult',
    'SDTLexicalForm', 'eWORDTYPE_DELETED', 'DISPID_SRGRules',
    'DISPID_SASetState', 'SPFILEMODE', 'SPPS_Noun', 'SINoSignal',
    'DISPID_SGRsDynamic', 'SSTTDictation', 'SAFTADPCM_11kHzStereo',
    'SPPS_Interjection', 'SVEVoiceChange', 'DISPID_SOTId',
    'SpeechCategoryAppLexicons', 'DISPID_SOTIsUISupported',
    'DISPID_SOTGetDescription', 'DISPID_SLWLangId',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRProfile', 'SPSInterjection',
    'DISPID_SPARecoResult', 'SpeechAudioState',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechPhraseRule',
    'DISPID_SVEBookmark', 'ISpMMSysAudio', 'ISpeechAudioFormat',
    'DISPID_SVGetAudioOutputs', 'SPWORDPRONUNCIATIONLIST', 'SVP_1',
    'DISPID_SOTDisplayUI', 'DISPID_SRRTTickCount',
    'DISPID_SMSADeviceId', 'eLEXTYPE_PRIVATE3', 'ISpRecoGrammar',
    'SAFT16kHz16BitMono', 'DISPID_SVSLastStreamNumberQueued',
    'SVF_Stressed', 'ISpeechPhraseReplacement', 'eLEXTYPE_MORPHOLOGY',
    'SPPHRASEELEMENT', 'DISPID_SLWsItem',
    'DISPID_SGRSAddRuleTransition', 'SAFT16kHz8BitStereo',
    'SpeechTokenContext', 'SPPROPERTYINFO', 'ISpAudio',
    'DISPID_SRRSaveToMemory', 'DISPID_SVSkip', 'DISPID_SRIsShared',
    'DISPID_SRRAudioFormat', 'DISPID_SGRSRule',
    'DISPID_SVEAudioLevel', 'SPSEMANTICERRORINFO',
    'eLEXTYPE_RESERVED10', 'DISPID_SRRTimes', 'SPDKL_DefaultLocation',
    'SPEI_END_INPUT_STREAM', 'SSSPTRelativeToCurrentPosition',
    'SpInprocRecognizer', 'DISPID_SLAddPronunciationByPhoneIds',
    'SVP_14', 'DISPID_SPPBRestorePhraseFromMemory', 'SPSHORTCUTTYPE',
    'eLEXTYPE_RESERVED7', 'SRSActiveAlways',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVPriority',
    'DISPID_SLPs_NewEnum', 'DISPID_SRRTLength',
    'ISpeechAudioBufferInfo', 'SPRST_NUM_STATES', 'SVEPhoneme',
    'SAFT12kHz16BitMono', 'SpMemoryStream',
    ...
    'SpCustomStream', 'DISPID_SGRSTRule', 'DISPID_SMSALineId',
    'SAFT48kHz16BitStereo', 'SREStreamEnd', 'SAFTGSM610_11kHzMono',
    'SITooSlow', 'SpObjectToken', 'ISequentialStream', 'SRERequestUI',
    'DISPID_SPERetainedStreamOffset', 'eLEXTYPE_PRIVATE1',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SOTDataKey',
    'SPAO_NONE', 'DISPID_SRCEInterference',
    'DISPID_SRGCmdLoadFromObject', 'ISpStream', 'DISPID_SAStatus',
    'SVEPrivate', 'SECHighConfidence', 'SVPAlert',
    'DISPID_SpeechObjectTokenCategory', 'Speech_Max_Pron_Length',
    ...
    'SAFTADPCM_22kHzStereo', 'SWPUnknownWordPronounceable',
    'SPGS_EXCLUSIVE', 'SpeechInterference',
    'DISPID_SPERetainedSizeBytes', 'SpFileStream',
    'DISPID_SpeechRecoContext', 'SPRULE', 'DISPID_SRCERecognition',
    'SPRULESTATE', 'SPWF_SRENGINE', 'DISPID_SVEViseme',
    'STCInprocHandler', 'SPEI_SOUND_START', 'DISPID_SVSLastResult',
    'SP_VISEME_0', 'DISPID_SLWPronunciations',
    'DISPID_SAFGetWaveFormatEx', 'SRTAutopause', 'DISPID_SRRAudio',
    'ISpeechLexiconPronunciation', 'DISPID_SLGetPronunciations',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVP_16',
    'SPINTERFERENCE_NOISE', 'DISPID_SRCRetainedAudio', 'SVP_21',
    'DISPID_SRCVoice', 'ISpeechDataKey', 'SPPS_RESERVED3',
    'SpeechGrammarTagWildcard', 'SpeechDisplayAttributes',
    'SPGS_DISABLED', 'SGLexicalNoSpecialChars',
    'DISPID_SRCERecognizerStateChange',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SVVolume',
    'ISpPhrase', 'SPLEXICONTYPE', 'SPEI_START_INPUT_STREAM',
    'SP_VISEME_15', 'DISPID_SPIElements', 'SPDKL_CurrentConfig',
    'DISPID_SPIGetDisplayAttributes', 'SDTRule',
    'DISPID_SASNonBlockingIO', 'ISpRecoCategory', 'SPEI_TTS_PRIVATE',
    'SDTReplacement', 'DISPID_SLWType', 'ISpeechGrammarRules',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPPARTOFSPEECH',
    'DISPID_SGRAttributes', 'DISPID_SpeechPhraseProperty',
    'SPEI_WORD_BOUNDARY', 'SASStop', 'DISPID_SRState',
    'DISPID_SPRuleChildren', 'SREHypothesis',
    'DISPIDSPTSI_ActiveOffset', 'SPCS_ENABLED',
    'SSSPTRelativeToStart', 'STSF_LocalAppData',
    'SAFT11kHz8BitStereo', 'SP_VISEME_4', 'ISpNotifyTranslator',
    'SAFTGSM610_8kHzMono', 'SDA_Consume_Leading_Spaces',
    'ISpRecoContext2', 'DISPID_SPIEnginePrivateData',
    'DISPID_SDKOpenKey', 'SAFT8kHz8BitStereo', 'SREPrivate',
    ...
    'SVSFNLPSpeakPunc', 'SAFTGSM610_22kHzMono', 'SGRSTTEpsilon',
    'SPVPRI_ALERT', 'SGSExclusive', 'SAFT11kHz16BitStereo',
    'SPLOADOPTIONS', 'SPGRAMMARSTATE', 'DISPID_SWFEBlockAlign',
    'SPPS_LMA', 'SPEI_REQUEST_UI', 'SpeechFormatType',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SREmulateRecognition', 'DISPID_SRStatus',
    'SAFT22kHz8BitStereo', 'eLEXTYPE_PRIVATE6',
    'SAFTCCITT_uLaw_44kHzMono', 'SLODynamic', 'SpeechRunState',
    'SAFT24kHz8BitStereo', 'ISpShortcut', 'DISPID_SPAPhraseInfo',
    'DISPID_SPRuleConfidence', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRRRecoContext', 'ISpeechMemoryStream',
    'ISpeechTextSelectionInformation', 'DISPID_SVSRunningState',
    'eLEXTYPE_PRIVATE7', 'SRAONone', 'ISpEventSource',
    'DISPID_SABIBufferSize', 'SDTAll', 'SAFT22kHz16BitStereo',
    'DISPID_SPPsCount', 'SPRST_INACTIVE', 'DISPID_SDKEnumKeys',
    'SPEI_RESERVED6', 'SPWORDLIST', 'SVP_0', 'SP_VISEME_5',
    'DISPID_SpeechFileStream', 'DISPID_SRCEventInterests',
    'DISPID_SABIEventBias', 'DISPID_SVEStreamStart',
    'SpUnCompressedLexicon', 'eLEXTYPE_PRIVATE10', 'SPEVENT',
    'SpeechBookmarkOptions', 'SPEI_RESERVED3', 'SpeechRecoEvents',
    'SRSInactiveWithPurge', 'DISPID_SRCEAudioLevel',
    'DISPID_SOTCEnumerateTokens',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVP_2',
    'SPSERIALIZEDPHRASE', 'DISPID_SRDisplayUI', 'SPEI_SR_BOOKMARK',
    ...
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SOTsItem', 'SPSHORTCUTPAIR',
    'DISPID_SpeechPhraseProperties', 'SRESoundStart',
    'SPSHT_NotOverriden', 'SpeechPropertyAdaptationOn',
    'SVSFParseSsml', 'SPEI_SR_PRIVATE', 'ISpeechPhraseInfoBuilder',
    'DISPID_SDKDeleteValue', 'DISPID_SOTSetId', 'SVP_11',
    'ISpProperties', 'SREAudioLevel', 'DISPID_SpeechPhraseElement',
    'SPAR_High', 'SPLO_STATIC', 'SAFT8kHz16BitStereo',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPBO_AHEAD',
    'eLEXTYPE_LETTERTOSOUND', 'SPVPRI_OVER', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechGrammarRuleState',
    ...
    'eLEXTYPE_PRIVATE20', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SLTUser', 'SpPhoneConverter', 'SpeechEngineConfidence',
    'SpeechSpecialTransitionType', 'SPPHRASEPROPERTY', 'SPEI_MIN_TTS',
    'SVPNormal', 'DISPID_SpeechPhraseReplacements', 'eLEXTYPE_USER',
    'DISPID_SLGetWords', 'SP_VISEME_3', 'SpeechTokenValueCLSID',
    'SAFT44kHz16BitStereo', 'SAFT11kHz16BitMono',
    'ISpeechAudioStatus', 'ISpNotifySource', 'SP_VISEME_10',
    'eLEXTYPE_PRIVATE18', 'SAFTADPCM_44kHzStereo', 'SVSFVoiceMask',
    'DISPID_SPRText', 'SPPS_NotOverriden',
    'DISPID_SVSInputSentenceLength', 'DISPID_SDKEnumValues',
    'SWTAdded', 'DISPID_SABufferInfo', 'DISPID_SBSFormat',
    'DISPID_SOTMatchesAttributes', 'DISPID_SVAlertBoundary', 'SVP_19',
    'SpeechVoicePriority', 'DISPID_SpeechLexiconProns',
    'DISPID_SpeechBaseStream', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SVEStreamEnd', 'SVSFNLPMask', 'ISpGrammarBuilder',
    'SPEI_SOUND_END', 'SVF_None', 'DISPID_SLPType',
    'ISpObjectWithToken', 'DISPID_SAFGuid', 'STCInprocServer',
    'DISPID_SVSpeakStream', 'DISPID_SGRsAdd', 'ISpeechRecoResult',
    'DISPID_SOTCDefault', 'SpeechEmulationCompareFlags',
    'eLEXTYPE_PRIVATE12', 'DISPID_SPEsCount',
    'SpeechEngineProperties', 'SpStreamFormatConverter',
    'SGRSTTWildcard', 'SpPhoneticAlphabetConverter', 'SVSFPersistXML',
    'ISpRecoResult', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SASCurrentSeekPosition', 'SREPhraseStart',
    ...
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE2',
    'ISpeechPhraseElements', 'DISPID_SFSClose', 'SRCS_Disabled',
    'SP_VISEME_19', 'DISPID_SPCPhoneToId',
    'DISPID_SRRSetTextFeedback', 'SPDKL_CurrentUser',
    'SpeechDataKeyLocation', 'SpeechPropertyResponseSpeed',
    'ISpeechRecognizerStatus', 'ISpObjectToken', 'SDKLLocalMachine',
    ...
    'SpeechRegistryLocalMachineRoot', 'SPEI_MIN_SR', 'SGDisplay',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SOTCategory', 'DISPID_SPEsItem',
    'SREStreamStart', 'ISpeechGrammarRule', 'DISPID_SOTRemove',
    'SPEI_TTS_AUDIO_LEVEL', 'SECFIgnoreWidth', 'SDTAudio',
    'SPWT_DISPLAY', 'SREPropertyStringChange',
    'DISPID_SRAudioInputStream', 'SGDSActiveWithAutoPause',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SBSWrite',
    'SpeechGrammarRuleStateTransitionType', 'SPDATAKEYLOCATION',
    'SPCATEGORYTYPE', 'IStream', 'SREAdaptation', 'SVEEndInputStream',
    'DISPID_SPIStartTime', 'DISPID_SRCResume', 'SP_VISEME_20',
    'DISPID_SVSVisemeId', 'DISPID_SRSetPropertyString',
    'DISPID_SRGSetTextSelection', 'SAFT11kHz8BitMono',
    'SAFTCCITT_ALaw_44kHzStereo', 'SRARoot', 'SPSMF_SAPI_PROPERTIES',
    'SVSFPurgeBeforeSpeak', 'SPPS_RESERVED2', 'SPSHT_OTHER',
    'SPAS_STOP', 'SPCONTEXTSTATE', 'SVP_20',
    'DISPID_SpeechLexiconWord', 'DISPID_SAVolume', '_RemotableHandle',
    'SPFM_CREATE_ALWAYS', 'DISPID_SVSLastBookmark',
    'SpInProcRecoContext', 'SPDKL_LocalMachine', 'SAFT44kHz16BitMono',
    'DISPID_SGRAddState', 'SVEBookmark', 'DISPID_SPPChildren',
    'SPXRO_Alternates_SML', 'SPCT_SUB_DICTATION',
    'DISPID_SOTs_NewEnum', 'SPAO_RETAIN_AUDIO', 'SRTReSent', 'SVP_3',
    'SpMMAudioOut', 'IInternetSecurityManager', 'SAFTADPCM_11kHzMono',
    'SPINTERFERENCE', 'SGRSTTRule', 'DISPID_SRCEStartStream',
    'SpeechAudioFormatGUIDText', 'ISpeechResourceLoader',
    ...
    'eLEXTYPE_PRIVATE9', 'SAFTADPCM_22kHzMono', 'SPCT_SUB_COMMAND',
    'DISPID_SLAddPronunciation', 'ISpeechRecoContext',
    'SpObjectTokenCategory', 'DISPID_SVRate', 'DISPID_SPRs_NewEnum',
    'DISPID_SBSRead', 'SPAS_CLOSED', 'SPVPRI_NORMAL', 'SPPHRASERULE',
    'DISPID_SGRId', 'DISPID_SGRSTWeight', 'SPRST_ACTIVE',
    'SPEI_SR_RETAINEDAUDIO', 'SRAInterpreter', 'SRTExtendableParse',
    'SVP_5', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVSInputSentencePosition', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRCCreateResultFromMemory', 'IEnumSpObjectTokens',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SVEVoiceChange',
    'SAFT16kHz8BitMono', 'SpeechRetainedAudioOptions',
    'SAFT8kHz16BitMono', 'SPSHORTCUTPAIRLIST', 'SWTDeleted',
    ...
    'SPRS_ACTIVE', 'DISPID_SpeechAudioStatus', 'STSF_AppData',
    'SpeechGrammarState', 'DISPID_SRGReset', 'SECLowConfidence',
    'DISPID_SGRName', 'DISPID_SRGetFormat', 'ISpeechRecognizer',
    'DISPID_SPEDisplayAttributes', 'ISpeechVoice',
    'DISPID_SDKSetStringValue', 'SECFEmulateResult',
    'DISPID_SGRSTsItem', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SOTCSetId', 'SVESentenceBoundary',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFTCCITT_ALaw_11kHzStereo',
    'SGDSInactive', 'DISPID_SPAsItem', 'SVP_18', 'SPVISEMES',
    ...
    'ISpRecoContext', 'DISPID_SRCEPhraseStart', 'WAVEFORMATEX',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SGRSTPropertyName',
    'SpShortcut', 'SPEI_VOICE_CHANGE', 'DISPID_SRGetRecognizers',
    'SpMMAudioEnum', 'DISPID_SBSSeek', 'SPINTERFERENCE_TOOFAST',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SVEPhoneme', 'DISPID_SPRuleId',
    'ISpEventSink', 'DISPID_SMSSetData', 'SAFTADPCM_44kHzMono',
    'SAFT44kHz8BitMono', 'DISPID_SRGCmdLoadFromMemory', 'SFTSREngine',
    'eLEXTYPE_PRIVATE5', 'SpNotifyTranslator',
    'DISPID_SPIAudioSizeBytes', 'SREFalseRecognition',
    'DISPID_SGRsCommitAndSave', 'SpeechPartOfSpeech',
    'ISpeechObjectTokens', 'SPADAPTATIONRELEVANCE', 'SSFMOpenForRead',
    'SPSHT_Unknown', 'DISPID_SWFEAvgBytesPerSec', 'SFTInput',
    'SVSFIsXML', 'ISpeechPhraseProperty', 'DISPID_SpeechLexicon',
    'DISPID_SRGDictationLoad', 'SPSUnknown', 'SDKLDefaultLocation',
    'SAFTADPCM_8kHzStereo', 'eLEXTYPE_PRIVATE8',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_START_SR_STREAM', 'SVP_9',
    'DISPID_SpeechLexiconPronunciation', 'SVSFDefault', 'SVEViseme',
    'SpeechCategoryPhoneConverters', 'SpeechGrammarWordType',
    'eLEXTYPE_PRIVATE19', 'SGSDisabled', 'ISpXMLRecoResult',
    'SPFM_NUM_MODES', 'DISPID_SPCLangId', 'DISPID_SRRPhraseInfo',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SVAudioOutput',
    'SP_VISEME_14', 'SPSVerb', 'SSFMOpenReadWrite',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SPEActualConfidence', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SPIRetainedSizeBytes', 'SECNormalConfidence',
    'DISPID_SRGState', 'SpeechTokenIdUserLexicon',
    'DISPID_SPPs_NewEnum', 'SPPHRASE', 'SVP_8',
    'DISPID_SWFESamplesPerSec', 'SPSNoun', 'SPFM_OPEN_READWRITE',
    ...
    'ISpRecognizer', 'SPRS_INACTIVE', 'SVPOver',
    'DISPID_SRCERequestUI', 'SVSFIsFilename', 'SVSFUnusedFlags',
    'SAFT12kHz8BitStereo', 'SGSEnabled', 'SpeechRecognitionType',
    'DISPID_SGRsCommit', 'DISPID_SLWsCount', 'SPBOOKMARKOPTIONS',
    'DISPID_SVGetAudioInputs', 'SPPHRASEREPLACEMENT',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SMSGetData',
    'DISPIDSPTSI_SelectionOffset', 'SPAR_Low',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechAddRemoveWord',
    'DISPID_SRCEEnginePrivate', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechCategoryVoices', 'DISPIDSPRG', 'SPRECOCONTEXTSTATUS',
    'SpWaveFormatEx', 'SPEI_RESERVED2', 'SpeechTokenShellFolder',
    'SBONone', 'SSFMCreate', 'DISPID_SRCCreateGrammar',
    'DISPID_SRCEPropertyNumberChange', 'SPWORDPRONOUNCEABLE',
    'SPEI_PHRASE_START', 'eWORDTYPE_ADDED', 'STCRemoteServer',
    ...
    'SpeechTokenKeyFiles', 'DISPID_SRGCommit', 'SPEI_TTS_BOOKMARK',
    ...
    'SpeechDiscardType', 'SPAS_RUN', 'SPPS_Verb',
    'DISPID_SDKCreateKey', 'ISpeechGrammarRuleStateTransition',
    'SGDSActive', 'SREBookmark', 'SPSERIALIZEDRESULT',
    ...
    'DISPID_SpeechAudio', 'SVEWordBoundary', 'SVEStartInputStream',
    'DISPID_SPRulesCount', 'SVP_15', 'DISPID_SGRsItem',
    'SPCT_COMMAND', 'DISPID_SRRSpeakAudio', 'SpeechAllElements',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRCRecognizer',
    'DISPID_SRGCmdSetRuleIdState', 'ISpeechXMLRecoResult',
    'SPEI_PHONEME', 'DISPID_SFSOpen', 'SP_VISEME_13', 'SRAImport',
    'SP_VISEME_2', 'DISPID_SRCEBookmark', 'SP_VISEME_12',
    'ISpeechMMSysAudio', 'UINT_PTR', 'SPSSuppressWord',
    '_ISpeechRecoContextEvents', 'DISPID_SOTGetStorageFileName',
    'SpeechVoiceSpeakFlags', 'SGRSTTTextBuffer', 'ISpLexicon',
    'ISpeechGrammarRuleState', 'DISPID_SPRuleNumberOfElements',
    'ISpeechAudio', 'DISPID_SVSpeakCompleteEvent', 'STCLocalServer',
    'SVEAudioLevel', 'SRSActive', 'SVSFlagsAsync',
    'SpeechRecoProfileProperties', 'SP_VISEME_21',
    'DISPID_SABufferNotifySize', 'eLEXTYPE_RESERVED6',
    'SPPS_SuppressWord', 'SpeechCategoryAudioIn', 'SPSMF_UPS',
    'DISPID_SPEDisplayText', 'SRERecoOtherContext',
    'SpeechRecoContextState', 'SP_VISEME_18', 'DISPID_SRSAudioStatus',
    'ISpeechWaveFormatEx', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SPPId', 'DISPID_SDKSetBinaryValue', 'SLOStatic',
    'SPAS_PAUSE', 'DISPID_SPIAudioStreamPosition',
    'SPSTREAMFORMATTYPE', 'DISPID_SPRuleParent',
    'DISPID_SRCESoundEnd', 'SRSEIsSpeaking', 'DISPID_SVStatus',
    'SpSharedRecoContext', 'SRSInactive',
    'DISPID_SRCEFalseRecognition', 'SpPhraseInfoBuilder',
    'SAFTCCITT_ALaw_8kHzStereo', 'STCAll',
    'ISpeechRecoResultDispatch', 'DISPID_SRCBookmark',
    '__MIDL_IWinTypes_0009', 'SVSFIsNotXML', 'SPCT_SLEEP',
    'SAFT32kHz8BitStereo', 'SAFT24kHz16BitMono', 'SINoise',
    'ISpeechGrammarRuleStateTransitions', 'SVEAllEvents',
    'SP_VISEME_9', 'DISPID_SRSClsidEngine',
    'SpeechTokenKeyAttributes', 'DISPID_SRCreateRecoContext',
    'SPPS_RESERVED1', 'ISpeechObjectToken', 'ISpObjectTokenCategory',
    'DISPID_SPPsItem', 'SSTTWildcard', 'DISPID_SpeechRecoResult2',
    'SpResourceManager', 'SPEI_RECOGNITION',
    'ISpeechPhraseAlternates', 'SPEI_INTERFERENCE',
    'SAFT32kHz16BitStereo', 'SpVoice', 'SPEI_RESERVED1',
    'DISPID_SVEEnginePrivate', 'SECFIgnoreCase',
    'DISPID_SRCRequestedUIType', 'DISPID_SRGCmdLoadFromFile',
    'SPEVENTENUM', 'SP_VISEME_7', 'SAFT24kHz16BitStereo',
    'SREInterference', 'SAFT22kHz8BitMono', 'SPEI_FALSE_RECOGNITION',
    'SPAUDIOOPTIONS', 'SRTEmulated', 'DISPID_SLPPartOfSpeech',
    'SAFTText', 'SRADefaultToActive', 'SVP_13', 'SPRECOGNIZERSTATUS',
    'SRSEDone', 'ISpPhraseAlt', 'DISPID_SRGRecoContext',
    'SPGRAMMARWORDTYPE', 'eLEXTYPE_RESERVED8',
    ...
    'DISPID_SGRSTPropertyId', 'SpeechCategoryAudioOut',
    'DISPID_SPRsCount', 'SAFT22kHz16BitMono', 'SASClosed',
    'SPSModifier', 'SpeechVoiceEvents', 'SRERecognition',
    'DISPID_SRRTStreamTime', 'SPRS_ACTIVE_USER_DELIMITED',
    'SDKLCurrentConfig', 'SpeechAudioVolume', 'DISPID_SPAs_NewEnum',
    'SPEI_VISEME', 'SPSFunction', 'SpeechStreamFileMode',
    'SAFT48kHz8BitStereo', 'DISPID_SMSAMMHandle', 'DISPID_SPIRule',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SPEAudioTimeOffset',
    'SpeechRegistryUserRoot', 'SPPS_RESERVED4', 'ISpeechVoiceStatus',
    'DISPID_SpeechWaveFormatEx', 'SPGS_ENABLED', 'SpeechLoadOption',
    'SPCT_DICTATION', 'SVP_12', 'SP_VISEME_1', 'IEnumString',
    'DISPID_SGRSTText', 'SGDSActiveUserDelimited', 'DISPIDSPTSI',
    'SREPropertyNumChange', 'SPWT_PRONUNCIATION', 'SDKLCurrentUser',
    'SpLexicon', 'DISPID_SPEs_NewEnum', 'DISPID_SPEEngineConfidence',
    'SBOPause', 'SP_VISEME_17', 'SPEI_MAX_TTS',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechCustomStream',
    'SPXMLRESULTOPTIONS', 'SPEI_UNDEFINED', 'SAFT44kHz8BitStereo',
    'DISPID_SPAsCount', 'SP_VISEME_8', 'DISPID_SVSInputWordLength',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SLPPhoneIds',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRCEEndStream',
    'SpeechCategoryRecoProfiles', 'tagSPPROPERTYINFO',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRSTransitions', 'SPEI_MAX_SR',
    ...
    'DISPID_SRCPause', 'eLEXTYPE_RESERVED4', 'SVSFParseMask',
    'SPXRO_SML', 'eLEXTYPE_PRIVATE17', 'SSSPTRelativeToEnd',
    'Speech_Max_Word_Length', 'SVP_10', 'SPRECORESULTTIMES',
    'DISPID_SCSBaseStream', 'SpeechWordPronounceable',
    'ISpSerializeState', 'SpeechTokenKeyUI', '_ISpeechVoiceEvents',
    'DISPID_SABIMinNotification', 'DISPID_SpeechRecoResultTimes',
    'SP_VISEME_11', 'ISpStreamFormat', 'ISpeechPhraseRules',
    'SAFT8kHz8BitMono', 'SAFTCCITT_ALaw_8kHzMono',
    'ISpeechLexiconPronunciations', 'ISpVoice', 'ISpeechFileStream',
    'SP_VISEME_6', 'SECFIgnoreKanaType', 'DISPID_SVGetVoices',
    'DISPID_SGRsFindRule', 'eLEXTYPE_APP', 'SASPause',
    'DISPID_SLPSymbolic', 'SREAllEvents', 'DISPID_SPRuleName',
    'DISPID_SOTsCount', 'ISpeechPhraseProperties',
    'SPEVENTSOURCEINFO', 'DISPID_SpeechRecoResult', 'SECFDefault',
    'DISPID_SVEWord', 'SRAORetainAudio', 'DISPID_SPRFirstElement',
    'DISPID_SPRuleEngineConfidence', 'eLEXTYPE_RESERVED9',
    'SPBO_PAUSE', 'DISPID_SRAudioInput', 'DISPID_SLWs_NewEnum',
    'DISPID_SpeechLexiconWords', 'DISPID_SVSCurrentStreamNumber',
    'SDTProperty', 'DISPID_SPCIdToPhone', 'SAFTCCITT_ALaw_44kHzMono',
    'SSFMCreateForWrite', 'SPWORD', 'SVP_4', 'SAFT48kHz8BitMono',
    'ISpeechLexiconWords', 'SAFTTrueSpeech_8kHz1BitMono',
    'STSF_FlagCreate', 'DISPID_SADefaultFormat',
    'DISPID_SDKGetBinaryValue', 'ISpeechRecoResultTimes',
    'ISpNotifySink'
]

_check_version('1.2.1', 1700001438.323281)
